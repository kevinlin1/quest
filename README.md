...
Write compact **qu**izzes and t**ests** (quests) with Typst! To get started, see the <template/main.typ> file:
...
![Thumbnail of "My Quiz or Test" containing 4 numbered questions used only to demonstrate the quest template.](template/thumbnail.png)

## Usage

The simplest way to use this package is to adapt the <template/main.typ> file. This template file walks describes frontmatter necessary to write a compact quiz or test. However, the simplest frontmatter only requires specifying the name and author of the document:
